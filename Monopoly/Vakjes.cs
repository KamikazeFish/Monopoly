...
namespace Monopoly
{
    public class Vakjes
    {
        ...
        public Vakjes()
        {
            ...
            Add(new Vakje(Vakje.VakType.STRAAT, "Neude", "Utrecht", Color.FromArgb(255, 136, 0), null, 180, 90, 100, new int[] { 14, 70, 200, 550, 750, 950 }));
            Add(new Vakje(Vakje.VakType.ALGEMEENFONDS, "Algemeen fonds", "", Color.White, new PakAlgemeenFondsKaartActie()));
            Add(new Vakje(Vakje.VakType.STRAAT, "Biltstraat", "Utrecht", Color.FromArgb(255, 136, 0), null, 180, 90, 100, new int[] { 14, 70, 200, 550, 750, 950 }));
            Add(new Vakje(Vakje.VakType.STRAAT, "Vreeburg", "Utrecht", Color.FromArgb(255, 136, 0), null, 200, 100, 100, new int[] { 16, 80, 220, 600, 800, 1000 }));

            Add(new Vakje(Vakje.VakType.VRIJPARKEREN, "Vrij parkeren", "", Color.White));

            Add(new Vakje(Vakje.VakType.STRAAT, "A Kerkhof", "Groningen", Color.FromArgb(255, 0, 0), null, 220, 110, 150, new int[] { 18, 90, 250, 700, 875, 1050 }));
            Add(new Vakje(Vakje.VakType.KANS, "Kans", "", Color.White, new PakKansKaartActie()));
            Add(new Vakje(Vakje.VakType.STRAAT, "Grote Markt", "Groningen", Color.FromArgb(255, 0, 0), null, 220, 110, 150, new int[] { 18, 90, 250, 700, 875, 1050 }));
            Add(new Vakje(Vakje.VakType.STRAAT, "Heerestraat", "Groningen", Color.FromArgb(255, 0, 0), null, 240, 120, 150, new int[] { 20, 100, 300, 750, 925, 1100 }));

            Add(new Vakje(Vakje.VakType.STATION, "Station Noord", "", Color.White, null, 200, 100, 0, new int[] { 25, 50, 100, 200 }));

            Add(new Vakje(Vakje.VakType.STRAAT, "Spui", "'s-Gravenhage", Color.FromArgb(255, 255, 0), null, 260, 130, 150, new int[] { 22, 110, 330, 800, 975, 1150 }));
            Add(new Vakje(Vakje.VakType.STRAAT, "Plein", "'s-Gravenhage", Color.FromArgb(255, 255, 0), null, 260, 130, 150, new int[] { 22, 110, 330, 800, 975, 1150 }));
            Add(new Vakje(Vakje.VakType.NUTSBEDRIJF, "Waterleiding", "", Color.White, null, 150, 75, 0, new int[] { 4, 10 }));
            Add(new Vakje(Vakje.VakType.STRAAT, "Lange Poten", "'s-Gravenhage", Color.FromArgb(255, 255, 0), null, 280, 140, 150, new int[] { 24, 120, 360, 850, 1025, 1200 }));

            Add(new Vakje(Vakje.VakType.NAARGEVANGENIS, "Naar de gevangenis", "", Color.White, null));

            Add(new Vakje(Vakje.VakType.STRAAT, "Hofplein", "Rotterdam", Color.FromArgb(0, 128, 0), null, 300, 150, 200, new int[] { 26, 130, 390, 900, 1100, 1275 }));
            Add(new Vakje(Vakje.VakType.STRAAT, "Blaak", "Rotterdam", Color.FromArgb(0, 128, 0), null, 300, 150, 200, new int[] { 26, 130, 390, 900, 1100, 1275 }));
            Add(new Vakje(Vakje.VakType.ALGEMEENFONDS, "Algemeen fonds", "", Color.White, new PakAlgemeenFondsKaartActie()));
            Add(new Vakje(Vakje.VakType.STRAAT, "Coolsingel", "Rotterdam", Color.FromArgb(0, 128, 0), null, 320, 160, 200, new int[] { 28, 150, 450, 1000, 1200, 1400 }));

            Add(new Vakje(Vakje.VakType.STATION, "Station Oost", "", Color.White, null, 200, 100, 0, new int[] { 25, 50, 100, 200 }));

            Add(new Vakje(Vakje.VakType.KANS, "Kans", "", Color.White, new PakKansKaartActie()));
            Add(new Vakje(Vakje.VakType.STRAAT, "Leidschestraat", "Amsterdam", Color.FromArgb(51, 51, 255), null, 350, 175, 200, new int[] { 35, 175, 500, 1100, 1300, 1500 }));
            Add(new Vakje(Vakje.VakType.BELASTING, "Extra belasting", "", Color.White, null));
            Add(new Vakje(Vakje.VakType.STRAAT, "Kalverstraat", "Amsterdam", Color.FromArgb(51, 51, 255), null, 400, 200, 200, new int[] { 50, 200, 600, 1400, 1700, 2000 }));
        }
