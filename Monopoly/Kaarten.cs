...
namespace Monopoly
{
    ...
    public class KansKaarten : Kaarten
    {
        ...
        public KansKaarten()
        {
            ...
            VoegToe(new GaNaarKaart("Ga verder naar Barteljorisstraat. Indien u langs 'Start' komt, ontvangt u ƒ 200", new Vakje(Vakje.VakType.STRAAT, "Barteljorisstraat", "Haarlem", Color.FromArgb(238, 68, 221)), true));
            VoegToe(new GaNaarKaart("Reis naar station 'West' en indien u langs 'Start' komt, ontvangt u ƒ 200", new Vakje(Vakje.VakType.STATION, "Station West", "", Color.White), true));
            VoegToe(new GaNaarKaart("Ga verder naar 'Start'", new Vakje(Vakje.VakType.START, "Start", "", Color.White), true));
            VoegToe(new GaNaarKaart("Ga drie plaatsen terug", 3, true, true));
            VoegToe(new GaNaarKaart("Ga direct naar de gevangenis. Ga niet langs 'Start'. U ontvangt geen ƒ 200", new Vakje(Vakje.VakType.GEVANGENIS, "Gevangenis", "", Color.White), false));
            VoegToe(new GaNaarKaart("Ga verder naar de Heerestraat. Indien u langs 'Start' komt ontvangt u ƒ 200", new Vakje(Vakje.VakType.STRAAT, "Heerestraat", "Haarlem", Color.FromArgb(238, 68, 221)), true));
            ...
            VoegToe(new GaNaarKaart("Ga verder naar Kalverstraat", new Vakje(Vakje.VakType.STRAAT, "Kalverstraat", "Amsterdam", Color.FromArgb(51, 51, 255)), true));
    ...
    public class AlgemeenFondsKaarten : Kaarten
    {
        ...
        public AlgemeenFondsKaarten()
        {
            ...
            VoegToe(new GaNaarKaart("Ga terug naar Dorpsstraat (Ons Dorp)", new Vakje(Vakje.VakType.STRAAT, "Dorpsstraat", "Ons Dorp", Color.FromArgb(153, 51, 153)), true, true));
            VoegToe(new GaNaarKaart("Ga direct naar de gevangenis. Ga niet door 'Start', u ontvangt geen ƒ 200", new Vakje(Vakje.VakType.GEVANGENIS, "Gevangenis", "", Color.White), true));
